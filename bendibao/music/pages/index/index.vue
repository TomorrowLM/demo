		...
		<div class="main">
			...
			<div class="introduce">
				...
				<div class="introduce-info">
					<div>1. 音乐节将依照要求严格控制每日观众入场人数。</div>
					<div> 2. 检票入场时需要出示本人身份证，通过核实验证有效后方可入场，非入场人本人身份证会被谢绝入场。
					</div>
					<div> 3. 请配合现场工作人员的其他相关防疫检查，同时您 需要佩戴好口罩，配合测量体温合格后方可入场，活动全程也请佩戴好口罩，并保持安全距离。
					</div>
				</div>
