		...
		<div class="menu">
			<div class="container">
				...
				<div class="province-drop">
					<div class="selected selected-area" v-model="provinceCul" @click="provinceDrop">
						{{provinceCul}}
						<img src="@/static/路径 10.png" alt="">
					</div>
				...
				<div class="city-drop">
					<div class="selected selected-area" v-model="cityCul" @click="cityDrop">
						{{cityCul}}
						<img src="@/static/路径 10.png" alt="">
					</div>
