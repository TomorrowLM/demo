<template>
  <div>
    ...
    <intent-filter>
      ...
      <data android:scheme="shandwtolp" />
    </intent-filter>
  </div>
</template>
 <script>
  ...
  created() {
    ...
    Dialog.confirm({
      ...
      .then(() => {
        ...
        const url = `https://a.app.qq.com/o/simple.jsp?pkgname=net.pinrenwu.pinrenwu&android_schema=${android_schema}&ios_scheme=${ios_scheme}`;
      ...
      .catch(() => {
        ...
        const options = {
          ...
          yingyongbao: `//a.app.qq.com/o/simple.jsp?pkgname=net.pinrenwu.pinrenwu&android_schema=${android_schema}&ios_scheme=${ios_scheme}`,
          fallback: `https://a.app.qq.com/o/simple.jsp?pkgname=net.pinrenwu.pinrenwu&android_schema=${android_schema}&ios_scheme=${ios_scheme}`,
          timeout: 1000,
        };
