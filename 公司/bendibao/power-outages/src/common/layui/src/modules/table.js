...
layui.define(['lay', 'laytpl', 'laypage', 'layer', 'form', 'util'], function(exports){
  "use strict";
  ...
  //主模板
  ,TPL_MAIN = ['<div class="layui-form layui-border-box {{ d.VIEW_CLASS }} {{ d.VIEW_CLASS }}-{{ d.index }}{{# if(d.data.className){ }} {{ d.data.className }}{{# } }}" lay-filter="LAY-TABLE-FORM-DF-{{ d.index }}" lay-id="{{ d.data.id }}" style="{{# if(d.data.width){ }}width:{{d.data.width}}px;{{# } }} {{# if(d.data.height){ }}height:{{d.data.height}}px;{{# } }}">'
