...
export const  responseInterceptors = [async (response: any) => {
  ...
  if (code !== 200) {
    ...
    // ||response.url.indexOf("/adconsole/approve/updateTaskAnswerOne")!=-1||response.url.indexOf("/adconsole/approve/updateTaskAnswerTwo")!=-1
   if(code==400&&(response.url.indexOf("/adconsole/point/getPointUploadProgress")!=-1||response.url.indexOf("/adconsole/approve/queryFastPointAnswer")!=-1||response.url.indexOf("/adconsole/approve/updateTaskAnswerOne")!=-1||response.url.indexOf("/adconsole/approve/updateTaskAnswerTwo")!=-1)){
