...
export default defineConfig({
  ...
  routes: [
    ...
    //       name: '详情',
    //       path: '/list/detail',
    //       component: './survey/detail',
    //       routes:[
    //         {
    //           name: '数据清洗',
    //           path: '/list/detail/clean',
    //           component: './survey/detail/clean',
    //         },
    //         {
    //           name: '文字报告',
    //           path: '/list/detail/report',
    //           component: './survey/detail/report',
    //         },
    //         {
    //           key:"123",
    //           name: '数据报告',
    //           path: '/list/detail/dataReport',
    //           component: './survey/detail/dataReport',
    //           routes:[
    //             {
    //               name: '统计分析',
    //               path: '/list/detail/dataReport/statistical',
    //               component: './survey/detail/dataReport/statistical',
    //             },
    //             {
    //               name: '数据报告',
    //               path: '/list/detail/dataReport/analysis',
    //               component: './survey/detail/dataReport/analysis',
    //             },{
    //               name: '统计分析',
    //               path: '/list/detail/dataReport/statistical',
    //               component: './survey/detail/dataReport/statistical',
  ...
  scripts: process.env.NODE_ENV === 'development' ? [
    ...
    'https://g.alicdn.com/IMM/office-js/1.1.9/aliyun-web-office-sdk.min.js',
    // '@/utils/jquery-1.11.0.min.js',
    // '@/utils/jquery.table2excel.js',
    'https://datacentertest.data100.com/jquery-1.11.0.min.js',
    'https://datacentertest.data100.com/jquery.table2excel.js',
