      ...
      <List
        ...
        renderItem={item => {
          ...
          const actions = {
            ...
            '2': <a key="list-loadmore-more" href={item.ossUrl}>下载</a>,
          ...
          >
            <Skeleton avatar title={false} loading={item.loading} active>
              <List.Item.Meta
                ...
                title={<Tooltip title={item.fileName}>
                  <span style={{
                    width: '100%',
                    display: 'block',
                    whiteSpace: 'nowrap',
