...
export default () => {
  ...
  const getUserData = async (userId?: number) => {
    ...
    if (userId) {
      const { nickName, userName, dept: { deptId }, isAllSurvey, isAllSymposium, isAllDuocai, isAllMroc, phonenumber, email, sex, status, remark } = data;
      setEditUserName(userName);
      setInitialValues({ nickName, deptId, phonenumber, isAllSurvey, isAllSymposium, isAllDuocai, isAllMroc, email, sex, status, remark, postIds, roleIds })
    } else {
