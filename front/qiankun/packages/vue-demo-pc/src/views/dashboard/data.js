export function echart1() {
  return {
    ...
    tooltip: {
      ...
      // triggerOn:'click',
      formatter: args => {
        return `${args.name}的分数是${args.data[args.componentIndex + 1]}`;
      },
    },
    legend: {
      // data: ["语文", "数学"],
    ...
    series: [
      {
        ...
        symbolSize: function (val) {
          return val[2] / 5 > 30 ? 30 : val[2] / 5;
        },
        itemStyle: {
          // borderColor: 'red',
          color: (params) => {
            // console.log(params);
            return color(params.data.value[2]);
          },
          shadowColor: (params) => {
            // console.log(params);
            return color(params.data.value[2]);
