...
// import { ANTLRInputStream,InputStream, CommonTokenStream } from 'antlr4ts';
// import { ANTLRErrorListener, RecognitionException, Recognizer } from 'antlr4ts';
type TodoExpressionsContext = any;
import GrammarParser from './grammar/GrammarParser.js';
...
export default class AviService {
  ...
  // parse(code: string): { ast: TodoExpressionsContext, errors: ITodoLangError[] } {
    // const astJson = this.grammarParser.parse(code);
...
// const AviServiceInstance = new AviService();
