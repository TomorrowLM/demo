...
export default class DSLParser extends antlr4.Parser {
    ...
    static literalNames = [ null, '\'use\'', '\',\'', '\'in\'', '\'range\'', '\'try\'', 
                            '\'catch\'', '\'lambda\'', '\'->\'', '\'end\'', null, 
                            null, null, null, null, null, null, '\'**\'', 
                            '\'*\'', '\'/\'', '\'%\'', '\'!\'', '\'&&\'', '\'||\'', 
                            '\'!=\'', '\'>=\'', '\'>\'', '\'<=\'', '\'<\'', '\'==\'', 
                            '\'=~\'', '\'&\'', '\'|\'', '\'^\'', '\'~\'', '\'>>>\'', 
                            '\'<<\'', '\'>>\'', null, null, '\'true\'', '\'false\'', 
                            null, '\'=\'', '\'let\'', '\'fn\'', '\'return\'', '\'if\'', 
                            '\'else\'', '\'elsif\'', '\'break\'', '\'continue\'', 
                            '\'for\'', '\'switch\'', '\'while\'', '\'[\'', '\']\'', 
                            '\'(\'', '\')\'', '\'{\'', '\'}\'', '\';\'', '\'?\'', '\':\'', 
                            '\'.\'', '\'+\'', '\'-\'', '\'++\'', '\'--\'' ];
    static symbolicNames = [ null, null, null, null, null, null, null, null, 
                             null, null, 'RegularAssign', 'RegularLikeRight', 
                             'RegularRelationLeftExpression', 'RegularRelationRightExpression', 
                             'Space', 'NewLine', 'Comment', 'Power', 'Multiply', 
                             'Divide', 'Mode', 'Not', 'And', 'Or', 'NotEqual', 
                             'GreatThanOrEqual', 'GreatThan', 'LessThanOrEqual', 
                             'LessThan', 'Equal', 'RegulaLike', 'BitAnd', 
                             'BitOr', 'BitXor', 'BitNot', 'BitRightShiftNoSign', 
                             'BitLeftShift', 'BitRightShift', 'Number', 
                             'NumberHex', 'BooleanTrue', 'BooleanFalse', 
                             'String', 'Assignment', 'VariablePrefix', 'FunctionKeyword', 
                             'ReturnKeyword', 'IfKeyword', 'ElseKeyword', 
                             'ElseIfKeyword', 'Break', 'Continue', 'For', 
                             'Switch', 'While', 'OpenBracket', 'CloseBracket', 
                             'OpenParen', 'CloseParen', 'OpenBrace', 'CloseBrace', 
                             'SemiColon', 'QuestionMark', 'Colon', 'Dot', 
                             'Plus', 'Minus', 'PlusPlus', 'MinusMinus', 
                             'Identifier', 'UnexpectedCharacter' ];
    static ruleNames = [ 'root', 'program', 'statement', 'useStatement', 
                         'block', 'functionDeclaration', 'functionParameterList', 
                         'functionBody', 'variableStatement', 'variableDeclarationList', 
                         'variableDeclaration', 'assignListStatement', 'assignStatement', 
                         'ifStatement', 'elseIfStatement', 'elseStatement', 
                         'forStatements', 'forStatement', 'forStatementParametar', 
                         'forStatementBody', 'forInStatement', 'forInRangeStatement', 
                         'rangeFunction', 'whileStatement', 'whileStatementParametar', 
                         'whileStatementBody', 'tryStatement', 'returnStatement', 
                         'array', 'expression', 'lambdaExpression', 'identifierExpress', 
                         'plusExpression', 'minusExpression', 'rightPlusPlus', 
                         'rightMinusMinus', 'leftPlusPlus', 'leftMinusMinus', 
                         'relationOperator', 'operator2', 'operator1', 'bitOperator', 
                         'singleBitOperator', 'wrapperExpression', 'functionInvoikeExpression', 
                         'eos', 'literal' ];
	...
	useStatement() {
	    ...
	    try {
	        ...
	        this.state = 164;
	        this._errHandler.sync(this);
	        let la_ = this._interp.adaptivePredict(this._input,11,this._ctx);
	        if(la_===1) {
	            this.state = 153;
	...
	block() {
	    ...
	    try {
	        ...
	        this.state = 174;
	        this._errHandler.sync(this);
	        let la_ = this._interp.adaptivePredict(this._input,13,this._ctx);
	        if(la_===1) {
	            this.state = 173;
	            this.eos();
	...
	functionParameterList() {
	    let localctx = new FunctionParameterListContext(this, this._ctx, this.state);
	...
	functionBody() {
	    ...
	    try {
	        ...
	        this.state = 217;
	        this._errHandler.sync(this);
	        let la_ = this._interp.adaptivePredict(this._input,21,this._ctx);
	        if(la_===1) {
	            this.state = 216;
	            this.eos();
	...
	assignListStatement() {
	    let localctx = new AssignListStatementContext(this, this._ctx, this.state);
	...
	assignStatement() {
	    ...
	    try {
	        this.state = 274;
	        this._errHandler.sync(this);
	        let la_ = this._interp.adaptivePredict(this._input,29,this._ctx);
	        switch(la_) {
	        case 1:
	            this.enterOuterAlt(localctx, 1);
	            this.state = 261;
	...
	elseIfStatement() {
	    ...
	    try {
	        ...
	        this.state = 300;
	        this._errHandler.sync(this);
	        let la_ = this._interp.adaptivePredict(this._input,35,this._ctx);
	        if(la_===1) {
	            this.state = 299;
	            this.match(DSLParser.OpenParen);
	...
	forStatements() {
	    let localctx = new ForStatementsContext(this, this._ctx, this.state);
	    this.enterRule(localctx, 32, DSLParser.RULE_forStatements);
	    try {
	        this.state = 314;
	        this._errHandler.sync(this);
	        let la_ = this._interp.adaptivePredict(this._input,37,this._ctx);
	        switch(la_) {
	        case 1:
	            this.enterOuterAlt(localctx, 1);
	            this.state = 311;
	...
	forStatementParametar() {
	    let localctx = new ForStatementParametarContext(this, this._ctx, this.state);
	    ...
	    try {
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        if(((((_la - 4)) & ~0x1f) == 0 && ((1 << (_la - 4)) & ((1 << (DSLParser.T__3 - 4)) | (1 << (DSLParser.T__6 - 4)) | (1 << (DSLParser.RegularRelationLeftExpression - 4)) | (1 << (DSLParser.RegularRelationRightExpression - 4)) | (1 << (DSLParser.Not - 4)) | (1 << (DSLParser.BitNot - 4)))) !== 0) || ((((_la - 38)) & ~0x1f) == 0 && ((1 << (_la - 38)) & ((1 << (DSLParser.Number - 38)) | (1 << (DSLParser.NumberHex - 38)) | (1 << (DSLParser.BooleanTrue - 38)) | (1 << (DSLParser.BooleanFalse - 38)) | (1 << (DSLParser.String - 38)) | (1 << (DSLParser.OpenBracket - 38)) | (1 << (DSLParser.OpenParen - 38)) | (1 << (DSLParser.Plus - 38)) | (1 << (DSLParser.Minus - 38)) | (1 << (DSLParser.PlusPlus - 38)) | (1 << (DSLParser.MinusMinus - 38)) | (1 << (DSLParser.Identifier - 38)))) !== 0)) {
	            this.state = 327;
	            this.expression(0);
	        }
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        if(((((_la - 67)) & ~0x1f) == 0 && ((1 << (_la - 67)) & ((1 << (DSLParser.PlusPlus - 67)) | (1 << (DSLParser.MinusMinus - 67)) | (1 << (DSLParser.Identifier - 67)))) !== 0)) {
	            this.state = 331;
	            this.assignListStatement();
	        }
	...
	forStatementBody() {
	    let localctx = new ForStatementBodyContext(this, this._ctx, this.state);
	...
	forInRangeStatement() {
	    let localctx = new ForInRangeStatementContext(this, this._ctx, this.state);
	...
	rangeFunction() {
	    let localctx = new RangeFunctionContext(this, this._ctx, this.state);
	...
	whileStatement() {
	    ...
	    try {
	        ...
	        this.state = 371;
	        this._errHandler.sync(this);
	        let la_ = this._interp.adaptivePredict(this._input,45,this._ctx);
	        if(la_===1) {
	            this.state = 370;
	            this.match(DSLParser.OpenParen);
	...
	whileStatementParametar() {
	    let localctx = new WhileStatementParametarContext(this, this._ctx, this.state);
	...
	whileStatementBody() {
	    let localctx = new WhileStatementBodyContext(this, this._ctx, this.state);
	...
	returnStatement() {
	    ...
	    try {
	        ...
	        this.state = 411;
	        this._errHandler.sync(this);
	        let la_ = this._interp.adaptivePredict(this._input,51,this._ctx);
	        if(la_===1) {
	            this.state = 409;
	            this.expression(0);
	        ...
	        while(_alt!=2 && _alt!=antlr4.atn.ATN.INVALID_ALT_NUMBER) {
	            if(_alt===1) {
	                ...
	                case 4:
	                    ...
	                    this.state = 471;
	                    _la = this._input.LA(1);
	                    if(!(((((_la - 35)) & ~0x1f) == 0 && ((1 << (_la - 35)) & ((1 << (DSLParser.BitRightShiftNoSign - 35)) | (1 << (DSLParser.BitLeftShift - 35)) | (1 << (DSLParser.BitRightShift - 35)))) !== 0))) {
	...
	lambdaExpression() {
	    ...
	    try {
	        ...
	        this.state = 522;
	        this._errHandler.sync(this);
	        let la_ = this._interp.adaptivePredict(this._input,60,this._ctx);
	        if(la_===1) {
	            this.state = 521;
	            this.match(DSLParser.SemiColon);
	...
	identifierExpress() {
	    let localctx = new IdentifierExpressContext(this, this._ctx, this.state);
	...
	plusExpression() {
	    let localctx = new PlusExpressionContext(this, this._ctx, this.state);
	...
	minusExpression() {
	    let localctx = new MinusExpressionContext(this, this._ctx, this.state);
	...
	rightPlusPlus() {
	    let localctx = new RightPlusPlusContext(this, this._ctx, this.state);
	...
	rightMinusMinus() {
	    let localctx = new RightMinusMinusContext(this, this._ctx, this.state);
	...
	leftPlusPlus() {
	    let localctx = new LeftPlusPlusContext(this, this._ctx, this.state);
	...
	leftMinusMinus() {
	    let localctx = new LeftMinusMinusContext(this, this._ctx, this.state);
	...
	relationOperator() {
	    let localctx = new RelationOperatorContext(this, this._ctx, this.state);
	    ...
	    try {
	        ...
	        this.state = 554;
	        _la = this._input.LA(1);
	        if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << DSLParser.NotEqual) | (1 << DSLParser.GreatThanOrEqual) | (1 << DSLParser.GreatThan) | (1 << DSLParser.LessThanOrEqual) | (1 << DSLParser.LessThan) | (1 << DSLParser.Equal))) !== 0))) {
	        this._errHandler.recoverInline(this);
	        }
	        else {
	        	this._errHandler.reportMatch(this);
	...
	operator2() {
	    let localctx = new Operator2Context(this, this._ctx, this.state);
	    ...
	    try {
	        ...
	        this.state = 556;
	        _la = this._input.LA(1);
	        if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << DSLParser.Multiply) | (1 << DSLParser.Divide) | (1 << DSLParser.Mode))) !== 0))) {
	        this._errHandler.recoverInline(this);
	        }
	        else {
	        	this._errHandler.reportMatch(this);
	...
	operator1() {
	    let localctx = new Operator1Context(this, this._ctx, this.state);
	...
	singleBitOperator() {
	    let localctx = new SingleBitOperatorContext(this, this._ctx, this.state);
	...
	wrapperExpression() {
	    let localctx = new WrapperExpressionContext(this, this._ctx, this.state);
	...
	functionInvoikeExpression() {
	    let localctx = new FunctionInvoikeExpressionContext(this, this._ctx, this.state);
	    ...
	    try {
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        if(((((_la - 4)) & ~0x1f) == 0 && ((1 << (_la - 4)) & ((1 << (DSLParser.T__3 - 4)) | (1 << (DSLParser.T__6 - 4)) | (1 << (DSLParser.RegularRelationLeftExpression - 4)) | (1 << (DSLParser.RegularRelationRightExpression - 4)) | (1 << (DSLParser.Multiply - 4)) | (1 << (DSLParser.Not - 4)) | (1 << (DSLParser.BitNot - 4)))) !== 0) || ((((_la - 38)) & ~0x1f) == 0 && ((1 << (_la - 38)) & ((1 << (DSLParser.Number - 38)) | (1 << (DSLParser.NumberHex - 38)) | (1 << (DSLParser.BooleanTrue - 38)) | (1 << (DSLParser.BooleanFalse - 38)) | (1 << (DSLParser.String - 38)) | (1 << (DSLParser.OpenBracket - 38)) | (1 << (DSLParser.OpenParen - 38)) | (1 << (DSLParser.Plus - 38)) | (1 << (DSLParser.Minus - 38)) | (1 << (DSLParser.PlusPlus - 38)) | (1 << (DSLParser.MinusMinus - 38)) | (1 << (DSLParser.Identifier - 38)))) !== 0)) {
	            this.state = 577;
	            this._errHandler.sync(this);
	            _la = this._input.LA(1);
	            ...
	            while(_la===DSLParser.T__1 || _la===DSLParser.NewLine) {
	                ...
	                this.state = 592;
	                this._errHandler.sync(this);
	                let la_ = this._interp.adaptivePredict(this._input,68,this._ctx);
	                switch(la_) {
	                case 1:
	                    this.state = 590;
	                    this.expression(0);
	...
	literal() {
	    ...
	    try {
	        ...
	        this.state = 605;
	        _la = this._input.LA(1);
	        if(!(((((_la - 38)) & ~0x1f) == 0 && ((1 << (_la - 38)) & ((1 << (DSLParser.Number - 38)) | (1 << (DSLParser.NumberHex - 38)) | (1 << (DSLParser.BooleanTrue - 38)) | (1 << (DSLParser.BooleanFalse - 38)) | (1 << (DSLParser.String - 38)))) !== 0))) {
	        this._errHandler.recoverInline(this);
	        }
	        else {
	        	this._errHandler.reportMatch(this);
...
DSLParser.T__7 = 8;
DSLParser.T__8 = 9;
DSLParser.RegularAssign = 10;
DSLParser.RegularLikeRight = 11;
DSLParser.RegularRelationLeftExpression = 12;
DSLParser.RegularRelationRightExpression = 13;
DSLParser.Space = 14;
DSLParser.NewLine = 15;
DSLParser.Comment = 16;
DSLParser.Power = 17;
DSLParser.Multiply = 18;
DSLParser.Divide = 19;
DSLParser.Mode = 20;
DSLParser.Not = 21;
DSLParser.And = 22;
DSLParser.Or = 23;
DSLParser.NotEqual = 24;
DSLParser.GreatThanOrEqual = 25;
DSLParser.GreatThan = 26;
DSLParser.LessThanOrEqual = 27;
DSLParser.LessThan = 28;
DSLParser.Equal = 29;
DSLParser.RegulaLike = 30;
DSLParser.BitAnd = 31;
DSLParser.BitOr = 32;
DSLParser.BitXor = 33;
DSLParser.BitNot = 34;
DSLParser.BitRightShiftNoSign = 35;
DSLParser.BitLeftShift = 36;
DSLParser.BitRightShift = 37;
DSLParser.Number = 38;
DSLParser.NumberHex = 39;
DSLParser.BooleanTrue = 40;
DSLParser.BooleanFalse = 41;
DSLParser.String = 42;
DSLParser.Assignment = 43;
DSLParser.VariablePrefix = 44;
DSLParser.FunctionKeyword = 45;
DSLParser.ReturnKeyword = 46;
DSLParser.IfKeyword = 47;
DSLParser.ElseKeyword = 48;
DSLParser.ElseIfKeyword = 49;
DSLParser.Break = 50;
DSLParser.Continue = 51;
DSLParser.For = 52;
DSLParser.Switch = 53;
DSLParser.While = 54;
DSLParser.OpenBracket = 55;
DSLParser.CloseBracket = 56;
DSLParser.OpenParen = 57;
DSLParser.CloseParen = 58;
DSLParser.OpenBrace = 59;
DSLParser.CloseBrace = 60;
DSLParser.SemiColon = 61;
DSLParser.QuestionMark = 62;
DSLParser.Colon = 63;
DSLParser.Dot = 64;
DSLParser.Plus = 65;
DSLParser.Minus = 66;
DSLParser.PlusPlus = 67;
DSLParser.MinusMinus = 68;
DSLParser.Identifier = 69;
DSLParser.UnexpectedCharacter = 70;

DSLParser.RULE_root = 0;
DSLParser.RULE_program = 1;
DSLParser.RULE_statement = 2;
DSLParser.RULE_useStatement = 3;
DSLParser.RULE_block = 4;
DSLParser.RULE_functionDeclaration = 5;
DSLParser.RULE_functionParameterList = 6;
DSLParser.RULE_functionBody = 7;
DSLParser.RULE_variableStatement = 8;
DSLParser.RULE_variableDeclarationList = 9;
DSLParser.RULE_variableDeclaration = 10;
DSLParser.RULE_assignListStatement = 11;
DSLParser.RULE_assignStatement = 12;
DSLParser.RULE_ifStatement = 13;
DSLParser.RULE_elseIfStatement = 14;
DSLParser.RULE_elseStatement = 15;
DSLParser.RULE_forStatements = 16;
DSLParser.RULE_forStatement = 17;
DSLParser.RULE_forStatementParametar = 18;
DSLParser.RULE_forStatementBody = 19;
DSLParser.RULE_forInStatement = 20;
DSLParser.RULE_forInRangeStatement = 21;
DSLParser.RULE_rangeFunction = 22;
DSLParser.RULE_whileStatement = 23;
DSLParser.RULE_whileStatementParametar = 24;
DSLParser.RULE_whileStatementBody = 25;
DSLParser.RULE_tryStatement = 26;
DSLParser.RULE_returnStatement = 27;
DSLParser.RULE_array = 28;
DSLParser.RULE_expression = 29;
DSLParser.RULE_lambdaExpression = 30;
DSLParser.RULE_identifierExpress = 31;
DSLParser.RULE_plusExpression = 32;
DSLParser.RULE_minusExpression = 33;
DSLParser.RULE_rightPlusPlus = 34;
DSLParser.RULE_rightMinusMinus = 35;
DSLParser.RULE_leftPlusPlus = 36;
DSLParser.RULE_leftMinusMinus = 37;
DSLParser.RULE_relationOperator = 38;
DSLParser.RULE_operator2 = 39;
DSLParser.RULE_operator1 = 40;
DSLParser.RULE_bitOperator = 41;
DSLParser.RULE_singleBitOperator = 42;
DSLParser.RULE_wrapperExpression = 43;
DSLParser.RULE_functionInvoikeExpression = 44;
DSLParser.RULE_eos = 45;
DSLParser.RULE_literal = 46;
...
class FunctionParameterListContext extends antlr4.ParserRuleContext {
...
class AssignListStatementContext extends antlr4.ParserRuleContext {
...
class ForStatementsContext extends antlr4.ParserRuleContext {
...
class ForStatementParametarContext extends antlr4.ParserRuleContext {
	...
	assignListStatement = function(i) {
	    if(i===undefined) {
	        i = null;
	    }
	    if(i===null) {
...
class ForStatementBodyContext extends antlr4.ParserRuleContext {
...
class ForInRangeStatementContext extends antlr4.ParserRuleContext {
...
class RangeFunctionContext extends antlr4.ParserRuleContext {
...
class WhileStatementParametarContext extends antlr4.ParserRuleContext {
...
class WhileStatementBodyContext extends antlr4.ParserRuleContext {
...
class IdentifierExpressContext extends antlr4.ParserRuleContext {
...
class PlusExpressionContext extends antlr4.ParserRuleContext {
...
class MinusExpressionContext extends antlr4.ParserRuleContext {
...
class RightPlusPlusContext extends antlr4.ParserRuleContext {
...
class RightMinusMinusContext extends antlr4.ParserRuleContext {
...
class LeftPlusPlusContext extends antlr4.ParserRuleContext {
...
class LeftMinusMinusContext extends antlr4.ParserRuleContext {
...
class RelationOperatorContext extends antlr4.ParserRuleContext {
...
class Operator2Context extends antlr4.ParserRuleContext {
...
class Operator1Context extends antlr4.ParserRuleContext {
...
class SingleBitOperatorContext extends antlr4.ParserRuleContext {
...
class WrapperExpressionContext extends antlr4.ParserRuleContext {
...
class FunctionInvoikeExpressionContext extends antlr4.ParserRuleContext {
...
DSLParser.RootContext = RootContext; 
DSLParser.ProgramContext = ProgramContext; 
DSLParser.StatementContext = StatementContext; 
DSLParser.UseStatementContext = UseStatementContext; 
DSLParser.BlockContext = BlockContext; 
DSLParser.FunctionDeclarationContext = FunctionDeclarationContext; 
DSLParser.FunctionParameterListContext = FunctionParameterListContext; 
DSLParser.FunctionBodyContext = FunctionBodyContext; 
DSLParser.VariableStatementContext = VariableStatementContext; 
DSLParser.VariableDeclarationListContext = VariableDeclarationListContext; 
DSLParser.VariableDeclarationContext = VariableDeclarationContext; 
DSLParser.AssignListStatementContext = AssignListStatementContext; 
DSLParser.AssignStatementContext = AssignStatementContext; 
DSLParser.IfStatementContext = IfStatementContext; 
DSLParser.ElseIfStatementContext = ElseIfStatementContext; 
DSLParser.ElseStatementContext = ElseStatementContext; 
DSLParser.ForStatementsContext = ForStatementsContext; 
DSLParser.ForStatementContext = ForStatementContext; 
DSLParser.ForStatementParametarContext = ForStatementParametarContext; 
DSLParser.ForStatementBodyContext = ForStatementBodyContext; 
DSLParser.ForInStatementContext = ForInStatementContext; 
DSLParser.ForInRangeStatementContext = ForInRangeStatementContext; 
DSLParser.RangeFunctionContext = RangeFunctionContext; 
DSLParser.WhileStatementContext = WhileStatementContext; 
DSLParser.WhileStatementParametarContext = WhileStatementParametarContext; 
DSLParser.WhileStatementBodyContext = WhileStatementBodyContext; 
DSLParser.TryStatementContext = TryStatementContext; 
DSLParser.ReturnStatementContext = ReturnStatementContext; 
DSLParser.ArrayContext = ArrayContext; 
DSLParser.ExpressionContext = ExpressionContext; 
DSLParser.LambdaExpressionContext = LambdaExpressionContext; 
DSLParser.IdentifierExpressContext = IdentifierExpressContext; 
DSLParser.PlusExpressionContext = PlusExpressionContext; 
DSLParser.MinusExpressionContext = MinusExpressionContext; 
DSLParser.RightPlusPlusContext = RightPlusPlusContext; 
DSLParser.RightMinusMinusContext = RightMinusMinusContext; 
DSLParser.LeftPlusPlusContext = LeftPlusPlusContext; 
DSLParser.LeftMinusMinusContext = LeftMinusMinusContext; 
DSLParser.RelationOperatorContext = RelationOperatorContext; 
DSLParser.Operator2Context = Operator2Context; 
DSLParser.Operator1Context = Operator1Context; 
DSLParser.BitOperatorContext = BitOperatorContext; 
DSLParser.SingleBitOperatorContext = SingleBitOperatorContext; 
DSLParser.WrapperExpressionContext = WrapperExpressionContext; 
DSLParser.FunctionInvoikeExpressionContext = FunctionInvoikeExpressionContext; 
DSLParser.EosContext = EosContext; 
DSLParser.LiteralContext = LiteralContext; 
